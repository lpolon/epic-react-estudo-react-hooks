...
Um custom hook é uma função que utiliza hooks. Não é verdade que precisa ter o "use" no nome para funcionar. É só uma convenção para facilitar o linting do plugin do eslint. chokito.
